...
def dyspraxia():
    if request.method == "POST":
        ...
        if file and allowed_file(file.filename):
            ...
            return jsonify({"message": "File uploaded successfully!", "image_url": image_url, "gemini_text": gemini_text}), 200
        else:
            return jsonify({"message": "Invalid file format. Only png, jpg, jpeg, and gif are allowed."}), 400
